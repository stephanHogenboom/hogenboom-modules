...
class AddOrEditRelationScreen extends Module {
    private Stage window;
    private TextField relationName, relationPhone, relationEmail;
    private ValidatorKotlin validator = new ValidatorKotlin();

    void display(Address address, PropertyEntry entry) {
        window = new Stage();
